...
<meta property="og:url" content="https://mnre.plavan.dev/th/home">
...
<link rel="shortcut icon" href="<?=site_url()?>assets/favicon/favicon.ico" type="image/x-icon"/>
<link rel="apple-touch-icon" sizes="57x57" href="<?=site_url()?>assets/favicon/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="<?=site_url()?>assets/favicon/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="<?=site_url()?>assets/favicon/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?=site_url()?>assets/favicon/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="<?=site_url()?>assets/favicon/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?=site_url()?>assets/favicon/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="<?=site_url()?>assets/favicon/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="<?=site_url()?>assets/favicon/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="<?=site_url()?>assets/favicon/apple-icon-180x180.png">
<link rel="icon" type="image/png" href="<?=site_url()?>assets/favicon/favicon-16x16.png" sizes="16x16">
<link rel="icon" type="image/png" href="<?=site_url()?>assets/favicon/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="<?=site_url()?>assets/favicon/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="<?=site_url()?>assets/favicon/android-icon-192x192.png" sizes="192x192">
									...
									<div class="input-group">
										...
										<div class="input-group-append">
											<button class="btn btn-primary" type="button">
												<span class="feather icon-search typo-default"></span>
											</button>
										</div>
									</div>
								</div>
							...
							<div class="col">
								<div class="menu">
									<ul class="nav-list">
										<li>
											<a href="home"
												class="link <?php if ($this->uri->segment(1) == 'home') { echo 'active'; }?>"><?=lang('lbl_home')?></a>
										</li>
										<li>
											<a href="course"
												class="link <?php if ($this->uri->segment(1) == 'course') { echo 'active'; }?>"><?=lang('lbl_course')?></a>
										</li>
										<li>
											<a href="calendar"
												class="link <?php if ($this->uri->segment(1) == 'calendar') { echo 'active'; }?>"><?=lang('lbl_calendar')?></a>
										</li>
										<li>
											<a href="survey"
												class="link <?php if ($this->uri->segment(1) == 'survey') { echo 'active'; }?>"><?=lang('lbl_survey')?></a>
										</li>
										<!-- <li>
							...
							<div class="col-auto">
								<div class="member">
									<a href="/th/member" class="btn btn-primary">
                                        <span class="feather icon-user pr-1"></span>
                                        <?=lang('lbl_login')?>
									</a>
                                    <?php
                                    ...
                                    echo '<a href="javascript: setLang(\''.$lang_val.'\')" class="btn btn-info" style="border-radius: 50px;">'.$lang_lbl.'</a>';
                                    ?>
								</div>
							</div>
						</div>
                ...
                <div class="col-6 col-md-2">
                    <div class="menu">
                        ...
                        <ul class="nav-list fluid">
                            <li>
                                <a href="home" class="link">หน้าหลัก</a>
                            </li>
                            <li>
                                <a href="course" class="link">หลักสูตร</a>
                            </li>
                            <li>
                                <a href="calendar" class="link">ปฏิทินกิจกรรม</a>
                            </li>
                            <li>
                                <a href="survey" class="link">แบบสำรวจ</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-auto">
                    <div class="social">
                        <a href="https://www.facebook.com/hrdi.mnre.go.th" class="link" target="_blank"
                            title="Facebook">
                            <img src="https://mnre.plavan.dev/front/template/default/assets/img/icon/social-fb.svg" alt="">
                        </a>
...
<div class="wwp-cookie cookieconsent" id="BoxacceptCookie" style="background-image: url('assets/img/static/bg-mnre-pdpa.jpg');  ">
    <div class="container">
        <div class="cover-l">
            <img class="img-cover" src="assets/img/static/pic-icon-1-202128011611836145664.png" alt="MNRE">
        </div>
        <div class="inner">
            <h4 class="title">
            ...
            <p class="desc">
                ...
                <br>
                <a href="https://mnre.plavan.dev/pdpa/cookie" title="เรียนรู้เพิ่มเติม" target="_blank">เรียนรู้เพิ่มเติม</a>
                <a></a>
            </p>
            <a></a>
            <div class="action"><a>
        ...
        <div class="cover-r">
            <img class="img-cover" src="assets/img/static/pic-icon2-1-202128011611836152582.png" alt="MNRE">
        </div>
    </div>
</div>
...
<script>
    function setLang(lang) {
        $.get('api/setting/setlang/' + lang, function(rs) {
            if (rs.result) {
