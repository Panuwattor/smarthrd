        ...
        <div class="auth-page">
            <div class="container">
                <div class="auth-wrapper">
                    ...
                    <form data-toggle="validator" role="form" class="form-default pt-2" method="post" action="/th/member/register/4">
                        <div class="form-group">
                            <label class="control-label">เลขประจำตัวประชาชน</label>
                            <div class="block-control">
                                <input class="form-control" type="text" id="" name="" value="3550900095793" placeholder="13 หลัก" data-error="" required="" disabled="">
                        ...
                        <div class="text-center">
                            <span class="link text-underline link-primary typo-micro">เป็นบุคคลากรภายในที่ยังไม่มีรายชื่อในฐานข้อมูล</span>
                        </div>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <div class="block-control">
                                <select name="inputPrefix" id="inputPrefix" class="select-control" data-placeholder="โปรดระบุ" style="width: 100%;" required>
                                    <option></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="block-control">
                                <input class="form-control" type="text" id="inputFName" name="inputFName" value="" placeholder="โปรดระบุ" data-error="" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">ชื่อกลาง </label>
                            <div class="block-control">
                                <input class="form-control" type="text" id="inputMidName" name="inputMidName" value="" placeholder="โปรดระบุ" data-error="" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">นามสกุล <span class="text-danger">*</span></label>
                            <div class="block-control">
                                <input class="form-control" type="text" id="inputLName" name="inputLName" value="" placeholder="โปรดระบุ" data-error="" required>
                            </div>
                        </div>
                        <!-- <div class="form-group mt-4">
                            <label class="control-label">เพศ</label>
                            <div class="block-control">
                                <select name="inputSex" id="inputSex" class="select-control" data-placeholder="โปรดระบุ" style="width: 100%;">
                                    <option></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="block-control has-icon">
                                ...
                                <input class="form-control datepicker" type="text" id="inputDOB" name="inputDOB" value="" placeholder="" data-error="">
                            </div>
                        </div>
                        <div class="form-group mt-4">
                            <label class="control-label">ระดับการศึกษา</label>
                            <div class="block-control">
                                <select name="inputEDU" id="inputEDU" class="select-control" data-placeholder="โปรดระบุ" style="width: 100%;">
                                    <option></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="block-control">
                                <input class="form-control" type="email" id="inputEmail" name="inputEmail" value="" placeholder="" data-error="" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">เบอร์โทร <span class="text-danger">*</span></label>
                            <div class="block-control">
                                <input class="form-control" type="tel" id="inputPhone" name="inputPhone" value="" placeholder="" data-error="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-4">
                            <label class="control-label">ประเภทข้าราชการ/เจ้าหน้าที่ <span class="text-danger">*</span></label>
                            <div class="block-control">
                                <select name="inputjobType" id="inputjobType" class="select-control" data-placeholder="โปรดระบุ" style="width: 100%;" onchange="inputjobTypeChang()" required>
                                    <option></option>
                        ...
                        <div>
                            <div class="form-group">
                                <label class="control-label">ประเภทตำแหน่ง </label>
                                <div class="block-control">
                                    <select name="inputjobLevelGroup" id="inputjobLevelGroup" class="select-control" data-placeholder="โปรดระบุ" style="width: 100%;">
                                        <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="block-control">
                                    <input class="form-control" type="text" id="inputjobPosition" name="inputjobPosition" value="" placeholder="" data-error="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">ระดับ </label>
                                <div class="block-control">
                                    <select name="inputjobLevel" id="inputjobLevel" class="select-control" data-placeholder="โปรดระบุ" style="width: 100%;">
                                        <option></option>
                            ...
                            <div class="inputjobTypeGuest">
                                <div class="form-group">
                                    <label class="control-label">วันที่รับราชการ </label>
                                    <div class="block-control">
                                        <input class="form-control datepicker" type="text" id="inputjobStartDate" name="inputjobStartDate" value="" placeholder="" data-error="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">กระทรวง </label>
                                    <div class="block-control">
                                        <input class="form-control" type="text" id="inputjobMinistry" name="inputjobMinistry" value="" placeholder="" data-error="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">กรมต้นสังกัด </label>
                                    <div class="block-control">
                                        <input class="form-control" type="text" id="inputjobDepartment" name="inputjobDepartment" value="" placeholder="" data-error="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">ชื่อส่วนราชการที่สังกัด </label>
                                    <div class="block-control">
                                        <input class="form-control" type="text" id="inputjobSubDepartment" name="inputjobSubDepartment" value="" placeholder="" data-error="">
                                    </div>
                                </div>
                            </div>
                        </div>
